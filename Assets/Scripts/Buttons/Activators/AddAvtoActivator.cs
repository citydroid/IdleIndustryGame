...
public class AddAvtoActivator : MonoBehaviour, IButtonAction
{
    ...
    public void Execute()
    {
        Debug.Log("AddAvtoActivator: Execute вызван");

        if (objectToActivate == null)
        {
            Debug.LogWarning("AddAvtoActivator: objectToActivate не назначен.");
            return;
        }
        ...
        if (deactivateSiblings)
        {
            ...
            {
                Debug.LogWarning("AddAvtoActivator: objectToActivate не имеет родител€ Ч пропускаем деактивацию других.");
            }
        }
        else
        {
